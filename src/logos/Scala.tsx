...
const Scala = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      <linearGradient x1="0%" y1="50%" x2="100%" y2="50%" id="_ambl_Scala__a">
        <stop stopColor="#4F4F4F" offset="0%" />
        <stop stopColor="#000000" offset="100%" />
      </linearGradient>
      <linearGradient x1="0%" y1="50%" x2="100%" y2="50%" id="_ambl_Scala__b">
