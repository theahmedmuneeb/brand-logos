  ...
  >
    <defs>
      <linearGradient
        ...
        id="_ambl_Vector__a"
      >
        <stop stopColor="#10E7FF" offset="0%" />
        <stop stopColor="#33D5FF" offset="10.3%" />
        <stop stopColor="#60BDFF" offset="25.5%" />
        <stop stopColor="#86AAFF" offset="40.8%" />
        <stop stopColor="#A39AFF" offset="56%" />
        <stop stopColor="#B790FF" offset="71%" />
        <stop stopColor="#C489FF" offset="85.8%" />
        <stop stopColor="#C887FF" offset="100%" />
      </linearGradient>
      <linearGradient
        x1="21.0059701%"
        y1="54.0325908%"
