...
const GoogleBardIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={24}
    height={24}
    viewBox="0 0 256 258"
  ...
  >
    <defs>
      <radialGradient
        ...
        id="_ambl_GoogleBardIcon__a"
      >
        <stop stopColor="#1BA1E3" offset="0%" />
        <stop stopColor="#1BA1E3" offset="0.01%" />
        <stop stopColor="#5489D6" offset="30.0221%" />
        <stop stopColor="#9B72CB" offset="54.5524%" />
        <stop stopColor="#D96570" offset="82.5372%" />
        <stop stopColor="#F49C46" offset="100%" />
      </radialGradient>
      <radialGradient
        cx="-3.4086494%"
        cy="-54.2187761%"
    ...
    <g>
      <path
        ...
        fill="url(#_ambl_GoogleBardIcon__a)"
      />
      <path
        ...
        fill="url(#_ambl_GoogleBardIcon__b)"
      />
    </g>
  </svg>
);
export { GoogleBardIcon };
