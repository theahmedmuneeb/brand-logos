  ...
  >
    <defs>
      <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="a">
        ...
        <stop stopColor="#1A96D4" offset="80.12%" />
        <stop stopColor="#0E85C9" offset="91.3%" />
        <stop stopColor="#0071BC" offset="100%" />
      </linearGradient>
      <filter
        x="-50%"
        y="-50%"
    ...
    <g>
      <path
        d="M256,204.8 C256,232.96 232.96,256 204.8,256 L51.2,256 C23.04,256 0,232.96 0,204.8 L0,51.2 C0,23.04 23.04,0 51.2,0 L204.8,0 C232.96,0 256,23.04 256,51.2 L256,204.8 L256,204.8 Z"
        fill="#115A91"
      />
      <path
        d="M204.8,28.16 C217.50528,28.16 227.84,38.49472 227.84,51.2 L227.84,179.2 C227.84,191.90528 217.50528,202.24 204.8,202.24 L51.2,202.24 C38.49472,202.24 28.16,191.90528 28.16,179.2 L28.16,51.2 C28.16,38.49472 38.49472,28.16 51.2,28.16 L204.8,28.16"
        fill="#FFFFFF"
      />
      <path
