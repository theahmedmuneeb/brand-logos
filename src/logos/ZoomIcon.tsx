  ...
  >
    <defs>
      <linearGradient
        ...
        x2="76.334%"
        y2="4.3882%"
        id="_ambl_ZoomIcon__a"
      >
        <stop stopColor="#0845BF" offset="5.791949e-05%" />
        <stop stopColor="#0950DE" offset="19.11%" />
        <stop stopColor="#0B59F6" offset="38.23%" />
        <stop stopColor="#0B5CFF" offset="50%" />
        <stop stopColor="#0E5EFE" offset="67.32%" />
        <stop stopColor="#1665FC" offset="77.74%" />
        <stop stopColor="#246FF9" offset="86.33%" />
        <stop stopColor="#387FF4" offset="93.88%" />
