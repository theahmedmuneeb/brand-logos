...
const Bitnami = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={24}
    height={24}
    viewBox="0 0 256 287"
  ...
  >
    ...
    <g>
      ...
      />
      <path
        d="M159.2,125.2 L159.2,143.2 L159.2,161.2 L143.6,170.2 L128,179.3 L112.4,170.2 L96.8,161.2 L96.8,143.2 L96.8,125.2 L112.4,116.2 L128,107.2 L143.6,116.2 L159.2,125.2 Z"
        fill="#1A3B54"
      />
      <path
