...
const NodejsIconAlt = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={24}
    height={24}
    viewBox="0 0 256 292"
  ...
  >
    ...
    <g>
      <path
        ...
        fill="url(#_ambl_NodejsIconAlt__a)"
      />
      <g>
        <mask id="_ambl_NodejsIconAlt__d" fill="white">
          <use href="#_ambl_NodejsIconAlt__b" />
        </mask>
        <g />
        <path
          ...
          fill="url(#_ambl_NodejsIconAlt__c)"
          mask="url(#_ambl_NodejsIconAlt__d)"
        />
      </g>
      <g>
        <mask id="_ambl_NodejsIconAlt__g" fill="white">
          <use href="#_ambl_NodejsIconAlt__e" />
        </mask>
        <g />
        <path
          ...
          fill="url(#_ambl_NodejsIconAlt__f)"
          mask="url(#_ambl_NodejsIconAlt__g)"
        />
      </g>
    </g>
  </svg>
);
export { NodejsIconAlt };
