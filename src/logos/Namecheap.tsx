...
const Namecheap = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={24}
    height={24}
    viewBox="0 0 256 142"
  ...
  >
    <defs>
      <linearGradient
        ...
        x2="82.6195455%"
        y2="1.13156385%"
        id="_ambl_Namecheap__a"
      >
        <stop stopColor="#D4202C" offset="0%" />
        <stop stopColor="#D82D2B" stopOpacity={0.9583} offset="4.166156%" />
